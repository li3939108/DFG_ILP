...
for ($g=0; $g<$groupcount; $g++) {
   ...
   for ($k=0; $k<9; $k++){
	if($k==0)	{ $x1=0.65; $x2=0.65; $benchmark1 = "freqm.";	$benchmark2 = "+ canneal";}
	if($k==1)	{ $x1=1.60; $x2=1.60; $benchmark1 = "freqm.";	$benchmark2 = "+ x264";}
	if($k==2)	{ $x1=2.55; $x2=2.55; $benchmark1 = "fluid.";	$benchmark2 = "+ bodyt.";}
	if($k==3)	{ $x1=3.45; $x2=3.45; $benchmark1 = "bodyt.";	$benchmark2 = "+ vips";}
#	if($k==4)	{ $x1=4.25; $x2=4.25; $benchmark1 = "blackscholes";	$benchmark2 = "+ freqmine";}
	if($k==4)	{ $x1=5.15; $x2=5.15; $benchmark1 = "swapt.";	$benchmark2 = "+ freqm.";}
#	if($k==6)	{ $x1=6.05; $x2=6.05; $benchmark1 = "x264";	$benchmark2 = "+ vips";}
	if($k==5)	{ $x1=6.95; $x2=6.95; $benchmark1 = "black.";	$benchmark2 = "+ fluid.";}
	if($k==6)	{ $x1=7.85; $x2=7.85; $benchmark1 = "black.";	$benchmark2 = "+ vips";}
	if($k==7)	{ $x1=8.75; $x2=8.75; $benchmark1 = "fluid.";	$benchmark2 = "+ swapt.";}
	if($k==8)	{ $x1=9.65; $x2=9.65; $benchmark1 = "geomean";		$benchmark2 = "+ bodytrack";}
	$x1 = 0.62 + 1.01*$k;
	$x2 = 0.62 + 1.01*$k;
	
	if($k<8){
	        $label = sprintf("set label \"%s\" at %f,-0.04 center rotate by 0",
                         $benchmark1,$x1);#$groupname[$g]);
        	$extra_gnuplot_cmds .= "$label\n";
	        $label = sprintf("set label \"%s\" at %f,-0.1 center rotate by 0",
                         $benchmark2,$x2);#$groupname[$g],
        	$extra_gnuplot_cmds .= "$label\n";
	}
	else {
	        $label = sprintf("set label \"%s\" at %f,-0.07 center rotate by 0",
                         $benchmark1,$x1);#$groupname[$g]);
        	$extra_gnuplot_cmds .= "$label\n";
 
	}
	if($k==8){
	        $label = sprintf("set label \"0.997\" at 10.15,1.06 center rotate by 0");
        	$extra_gnuplot_cmds .= "$label\n";
	        #$label = sprintf("set label \"0.996\" at 8.55,1.05 center rotate by 0");
        	#$extra_gnuplot_cmds .= "$label\n";
...
$figcolor[$numfigclrs]="#dd66ff"; $fig_magenta=$colornm{'med_magenta'}=$basefigcolor + $numfigclrs++;
...
$figcolor[$numfigclrs]="#66ffff"; $fig_cyan=$colornm{'med_cyan'}=$basefigcolor + $numfigclrs++;
$figcolor[$numfigclrs]="#aaffff"; $fig_cyan=$colornm{'light_cyan'}=$basefigcolor + $numfigclrs++;
...
$figcolor[$numfigclrs]="#4444dd"; $fig_med_blue=$colornm{'dark1_blue'}=$basefigcolor + $numfigclrs++;
$figcolor[$numfigclrs]="#2222bb"; $fig_med_blue=$colornm{'dark2_blue'}=$basefigcolor + $numfigclrs++;
$figcolor[$numfigclrs]="#ffaaaa"; $fig_red=$colornm{'light_red'}=$basefigcolor + $numfigclrs++;
$figcolor[$numfigclrs]="#ff6666"; $fig_red=$colornm{'med_red'}=$basefigcolor + $numfigclrs++;
$num_nongrayscale = $numfigclrs;
# for grayscale
$figcolor[$numfigclrs]="#222222"; $fig_grey=$colornm{'grey1'}=$basefigcolor + $numfigclrs++;
$figcolor[$numfigclrs]="#333333"; $fig_grey=$colornm{'grey1_5'}=$basefigcolor + $numfigclrs++;
$figcolor[$numfigclrs]="#444444"; $fig_grey=$colornm{'grey2'}=$basefigcolor + $numfigclrs++;
$figcolor[$numfigclrs]="#555555"; $fig_grey=$colornm{'grey2_5'}=$basefigcolor + $numfigclrs++;
$figcolor[$numfigclrs]="#666666"; $fig_grey=$colornm{'grey3'}=$basefigcolor + $numfigclrs++;
$figcolor[$numfigclrs]="#777777"; $fig_grey=$colornm{'grey3_5'}=$basefigcolor + $numfigclrs++;
$figcolor[$numfigclrs]="#888888"; $fig_grey=$colornm{'grey4'}=$basefigcolor + $numfigclrs++;
$figcolor[$numfigclrs]="#999999"; $fig_grey=$colornm{'grey4_5'}=$basefigcolor + $numfigclrs++;
$figcolor[$numfigclrs]="#aaaaaa"; $fig_grey=$colornm{'grey5'}=$basefigcolor + $numfigclrs++;
$figcolor[$numfigclrs]="#bbbbbb"; $fig_grey=$colornm{'grey5_5'}=$basefigcolor + $numfigclrs++;
$figcolor[$numfigclrs]="#cccccc"; $fig_grey=$colornm{'grey6'}=$basefigcolor + $numfigclrs++;
$figcolor[$numfigclrs]="#dddddd"; $fig_grey=$colornm{'grey6_5'}=$basefigcolor + $numfigclrs++;
...
# jaeyeon
#print GNUPLOT "
#set style line 1 lt 2 lw 1 lc 7
#set style arrow 1 head filled size screen 0.025, 30, 45 ls 10
#set style arrow 2 nohead ls 1
#";

#set arrow from 0,0.2 to 10.69,0.2 as 2
...
set style arrow 1 nohead ls 1
		set arrow from $i*0.07,0.2*$g to $i*0.07+0.02,0.2*$g as 1
	";
	}
}
...
#    }
    for ($i=0; $i<$plotcount; $i++) {
        $dx = $i * 1100 -2000;#$key_text_line_space;
        printf FIG2DEV
"2 1 0 1 -1 $fillcolor[$i] $legend_depth 0 $fillstyle[$i] 0.000 0 0 0 0 0 5
\t %d %d %d %d %d %d %d %d %d %d  
",  $lx+$border+$dx, $ly+$border+$key_box_height+200+20, 
    $lx+$border+$dx, $ly+$border+200, 
    $lx+$border+$dx+$key_box_width+20, $ly+$border+200,
    $lx+$border+$dx+$key_box_width+20, $ly+$border+$key_box_height+200+20,
    $lx+$border+$dx, $ly+$border+$key_box_height+200+20;
    }
...
$legend_text_width + $leglen*&font_bb_diff_x($legend_old_fontsz, $legend_font_size,
  $legend[$legidx]),
$lx+$border+$key_box_width+$key_text_pre_space+$i*1100-2000,
$ly+$border+$key_box_height+$key_text_yshift+220,
$legend[$legidx];
