...
for ($g=0; $g<$groupcount; $g++) {
	...
	if($g==0)	{ $x1=0.65; $x2=0.65; $benchmark1 = "freqm.";	$benchmark2 = "+ canneal";}
	if($g==1)	{ $x1=1.60; $x2=1.60; $benchmark1 = "freqm.";	$benchmark2 = "+ x264";}
	if($g==2)	{ $x1=2.55; $x2=2.55; $benchmark1 = "fluid.";	$benchmark2 = "+ bodyt.";}
	if($g==3)	{ $x1=3.45; $x2=3.45; $benchmark1 = "bodyt.";	$benchmark2 = "+ vips";}
#	if($g==4)	{ $x1=4.25; $x2=4.25; $benchmark1 = "blackscholes";	$benchmark2 = "+ freqmine";}
	if($g==4)	{ $x1=5.15; $x2=5.15; $benchmark1 = "swapt.";	$benchmark2 = "+ freqm.";}
#	if($g==6)	{ $x1=6.05; $x2=6.05; $benchmark1 = "x264";	$benchmark2 = "+ vips";}
	if($g==5)	{ $x1=6.95; $x2=6.95; $benchmark1 = "black.";	$benchmark2 = "+ fluid.";}
	if($g==6)	{ $x1=7.85; $x2=7.85; $benchmark1 = "black.";	$benchmark2 = "+ vips";}
	if($g==7)	{ $x1=8.75; $x2=8.75; $benchmark1 = "fluid.";	$benchmark2 = "+ swapt.";}
	if($g==8)	{ $x1=9.65; $x2=9.65; $benchmark1 = "geomean";		$benchmark2 = "+ bodyt.";}
	$x1 = 0.62 + 1.01*$g;
	$x2 = 0.62 + 1.01*$g;
	
	if($g<8){
        $label = sprintf("set label \"%s\" at %f,-0.33 center rotate by 0",
                         $benchmark1,$x1);#$groupname[$g]);
        $extra_gnuplot_cmds .= "$label\n";
        $label = sprintf("set label \"%s\" at %f,-0.4 center rotate by 0",
                         $benchmark2,$x2);#$groupname[$g],
        $extra_gnuplot_cmds .= "$label\n";
	}
	else {
        $label = sprintf("set label \"%s\" at %f,-0.36 center rotate by 0",
                         $benchmark1,$x1);#$groupname[$g]);
        $extra_gnuplot_cmds .= "$label\n";
 
	        $label = sprintf("set label \"0.57\" at 10.25,0.57+0.06 center rotate by 0");
        	$extra_gnuplot_cmds .= "$label\n";
	        $label = sprintf("set label \"0.00\" at 10.55,0.50+0.06 center rotate by 0");
        	$extra_gnuplot_cmds .= "$label\n";
	}
...
#    }
    for ($i=0; $i<$plotcount; $i++) {
        $dx = $i * 1500 -750;#$key_text_line_space;
        printf FIG2DEV
"2 1 0 1 -1 $fillcolor[$i] $legend_depth 0 $fillstyle[$i] 0.000 0 0 0 0 0 5
\t %d %d %d %d %d %d %d %d %d %d  
...
$legend_text_width + $leglen*&font_bb_diff_x($legend_old_fontsz, $legend_font_size,
  $legend[$legidx]),
$lx+$border+$key_box_width+$key_text_pre_space+$i*1500-750,
